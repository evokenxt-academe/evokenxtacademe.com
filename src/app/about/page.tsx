        ...
        <div className="relative z-10 container mx-auto px-6 text-center pt-40 pb-32">
          ...
          >
            <h1 className="text-5xl md:text-8xl font-black text-white mb-8 leading-[0.95] tracking-tighter">
              Empowering the <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-300 to-purple-300 italic font-serif">Future</span> of Leaders
            </h1>

            <p className="text-lg md:text-xl text-slate-200/80 max-w-2xl mx-auto font-medium leading-relaxed mb-12">
              We deliver world-class education and industry-driven programs to bridge the gap between learning and global career success.
            </p>

            <div className="flex flex-wrap justify-center gap-6">
              <button className="px-10 py-4 bg-indigo-600 hover:bg-indigo-500 text-white rounded-full font-bold transition-all transform hover:scale-105 shadow-2xl shadow-indigo-500/40">
                Explore Programs
              </button>
              <button className="px-10 py-4 bg-white/10 hover:bg-white/20 text-white border border-white/20 rounded-full font-bold backdrop-blur-md transition-all">
                Meet the Team
              </button>
            </div>
          </motion.div>
