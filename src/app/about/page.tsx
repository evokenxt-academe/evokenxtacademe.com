        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row justify-center items-center gap-10 lg:gap-16">
          ...
          <div className="flex-1 flex flex-col items-start gap-6 max-w-xl">
            ...
            <h1 className="text-4xl md:text-5xl font-extrabold leading-[1.15] tracking-tight text-balance text-foreground">
              ...
              <span className="relative inline-flex items-center h-[1.3em] min-w-[200px] md:min-w-[240px] align-bottom overflow-hidden rounded-[1.25rem] border border-primary/20 bg-primary/10 backdrop-blur-md shadow-[0_8px_30px_-4px_rgba(var(--primary),0.15)] ml-1">
            ...
            <div className="flex flex-wrap items-center gap-3 pt-1">
              <Button
                size="lg"
                variant="outline"
                className="rounded-full px-7 h-12 font-semibold bg-background hover:bg-accent text-foreground"
              >
                Watch Video
                <Play
              ...
              <div className="space-y-8">
                <div className="space-y-4">
                  ...
                  <p className="text-muted-foreground text-[15px] leading-relaxed max-w-xl font-medium">
                    We bridge the gap between academic theory and industry
                    expertise, empowering the next generation of global leaders
                    through cutting-edge digital learning.
                  </p>
                </div>
                ...
                <div className="space-y-8 pt-4">
                  <div className="flex gap-6 group">
                    ...
                    <div>
                      <h4 className="text-lg font-bold text-foreground mb-2 uppercase tracking-tight">
                        Our Mission
                      </h4>
                      <p className="text-muted-foreground text-sm leading-relaxed max-w-md font-medium">
                        Bridging the critical gap between raw potential and
                        professional career success on a global scale.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-6 group">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-sm leading-relaxed max-w-md font-medium">
                        Empowering a global community of learners through
                        advanced technology and accessible education.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="pt-8 border-t border-border flex flex-col sm:flex-row items-center gap-8">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <div className="font-script text-2xl text-muted-foreground rotate-[-5deg] leading-none mb-1 opacity-80">
                        Joel Wish
                      </div>
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            ...
            <div className="max-w-xl">
              ...
              <p className="text-base md:text-lg text-muted-foreground mb-6 leading-relaxed">
                Run your ACCA preparation with zero guesswork. Get expert
                guidance, live classes, and mock tests to achieve results in
                months.
              </p>
              ...
              <div className="flex flex-wrap items-center gap-3 mb-4">
                <Button
                  size="lg"
                  className="h-11 px-6 rounded-xl font-bold shadow-sm hover:scale-[1.02] transition-transform"
                  asChild
                >
                  <Link href="/auth/login">
            ...
            <div className="relative w-full h-[300px] flex items-center justify-center lg:justify-end">
              ...
              <div className="absolute left-0 sm:left-4 md:left-10 top-4 w-[220px] sm:w-[260px] bg-background border border-border rounded-2xl shadow-xl overflow-hidden z-10 transform -rotate-2 hover:rotate-0 transition-all duration-500 hover:z-30">
                <div className="bg-muted/40 border-b border-border p-2.5 flex items-center gap-2">
                  <div className="w-5 h-5 rounded bg-primary/10 flex items-center justify-center text-[9px] font-black text-primary">
                    A
                  </div>
