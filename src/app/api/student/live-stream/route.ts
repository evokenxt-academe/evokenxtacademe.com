 ...
 *
 * Returns the currently active or most recently scheduled live stream
 * for a given course, along with its chat messages.
 */
export async function GET(request: NextRequest) {
    ...
    // Get live or most recent stream
    ...
    if (!stream) {
        return NextResponse.json({ stream: null, messages: [] })
    }
