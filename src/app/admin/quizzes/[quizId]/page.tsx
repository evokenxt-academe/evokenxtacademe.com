      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">
            Configure parameters for {quiz.title}
          </p>
        </div>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-3 pt-4 border-t">
                ...
                <RadioGroup
                  value={form.type}
                  onValueChange={(v) =>
                    setForm({ ...form, type: v as QuizType })
                  }
                >
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    {QUIZ_TYPE_INFO.map((t) => (
                      <label
                        key={t.value}
                        className={`flex items-start gap-3 rounded-lg border p-3 cursor-pointer transition-colors ${form.type === t.value ? "border-primary bg-primary/5" : "hover:bg-muted/50"}`}
                      >
            ...
            <CardContent className="space-y-5">
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(c) =>
                    setForm({ ...form, shuffle_questions: c })
                  }
                />
              </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(c) =>
                    setForm({ ...form, shuffle_options: c })
                  }
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <Select
                  value={form.show_answers_after}
                  onValueChange={(v) =>
                    setForm({
                      ...form,
                      show_answers_after: v as ShowAnswersAfter,
                    })
                  }
                >
                  <SelectTrigger>
