...
const plans = [
  {
    name: "Foundation",
    description: "For beginners starting their ACCA journey",
    price: { monthly: 0, annual: 0 },
    features: [
      "Access to 3 Knowledge papers",
  ...
  {
    name: "Professional",
    description: "For serious students aiming to qualify",
  ...
  {
    name: "Complete ACCA",
    description: "Full support to ACCA membership",
    ...
    features: [
      ...
      "Ethics module included",
      "Practical experience log help",
    ...
    <section id="pricing" ref={sectionRef} className="relative py-32 lg:py-40">
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="grid lg:grid-cols-12 gap-8 mb-20">
          <div className="lg:col-span-7">
            ...
            <h2 className={`text-6xl md:text-7xl lg:text-[128px] font-display tracking-tight leading-[0.9] transition-all duration-1000 ${
              ...
              Invest in
              <br />
              <span className="text-stroke">your future.</span>
            </h2>
          </div>
        ...
        <div className={`mt-20 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8 pt-12 border-t border-foreground/10 transition-all duration-1000 delay-500 ${
          ...
          <a href="/courses" className="text-sm underline underline-offset-4 hover:text-foreground transition-colors">
