      ...
      <div className="container mx-auto px-6 max-w-7xl">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-20 items-center">
          ...
          <div className="relative mx-auto w-full max-w-[480px] lg:max-w-none">
            ...
            <div className="absolute bottom-[-6%] right-0 w-[52%] overflow-hidden shadow-xl border-4 border-muted" style={{ aspectRatio: "4/3" }}>
              <img
            ...
            <div className="absolute top-6 -right-4 lg:right-4 bg-card shadow-xl border border-border px-4 py-3 flex items-center gap-3 z-20" style={{ minWidth: "180px" }}>
              <div>
                <p className="text-[11px] font-black uppercase tracking-widest text-muted-foreground mb-2">Our Instructors</p>
                <div className="flex items-center gap-1">
                  ...
                  <div className="w-7 h-7 rounded-full bg-primary flex items-center justify-center text-primary-foreground text-[10px] font-bold border-2 border-card ml-[-6px]">+</div>
                </div>
              </div>
            </div>
          </div>
