...
const faqs = [
  {
    ...
    answer:
      "Enrolling is simple. Browse our Course Catalogue, select your desired program, and click 'Enroll Now'. You'll get instant access to all video lectures, practice kits, and resources.",
  },
  {
    id: 2,
    question: "Are the courses available in Urdu and Hindi?",
    answer:
      "Yes! All of our ACCA and professional accounting courses are taught by expert instructors in Urdu and Hindi, making complex concepts far easier to understand.",
  },
  {
    id: 3,
    question: "What qualifications do your instructors hold?",
    answer:
      "Our instructors are fully qualified ACCA and CA professionals with years of industry experience and a proven track record of helping students pass on the first attempt.",
  },
  {
    id: 4,
    question: "Do I get access to recorded lectures?",
    answer:
      "Absolutely. Every course includes full access to our high-definition recorded lecture library so you can learn at your own pace, on your own schedule, on any device.",
  },
  {
    id: 5,
    question: "Is there any support for exam preparation?",
    answer:
      "Yes — every program includes comprehensive mock exams, past paper walkthroughs, and targeted revision kits built directly around the latest examiner reports and marking schemes.",
  },
];
          ...
          <div className="flex flex-col gap-6 lg:gap-8 w-full max-w-[480px]">
            <BlurFade delay={0.1} inView>
              <div className="flex flex-col items-start gap-5">
                <Badge
                  variant="outline"
                  className="px-6 py-2.5 text-[16px] rounded-full bg-transparent border-[1.5px] border-foreground/40 text-foreground flex items-center gap-3 font-medium shadow-sm"
                >
                  <Asterisk className="w-6 h-6 text-foreground animate-[spin_2s_linear_infinite]" />{" "}
                  FAQ
                </Badge>
                ...
                <p className="text-muted-foreground text-[16px] leading-relaxed">
                  ...
                  stress-free. With intuitive features, you can track your
                  spending and savings effortlessly.
                </p>
              </div>
            </BlurFade>
          ...
          <div className="flex flex-col">
            <BlurFade delay={0.15} inView>
              ...
              <p className="text-muted-foreground text-base leading-relaxed mb-10 max-w-md">
                Discover a world of knowledge and opportunity with Evokenxt —
                your platform for professional accounting excellence.
              </p>
            </BlurFade>
                ...
                return (
                  <BlurFade key={faq.id} delay={0.25 + idx * 0.05} inView>
                    <div className="overflow-hidden">
                      ...
                      >
                        <span
                          className={`text-[15px] font-semibold leading-snug pr-4 ${isOpen ? "text-primary" : "text-foreground"}`}
                        >
                          {faq.question}
                        </span>
                        <span
                          className={`flex-shrink-0 w-8 h-8 flex items-center justify-center transition-colors ${isOpen ? "text-primary" : "text-muted-foreground"}`}
                        >
                          {isOpen ? (
