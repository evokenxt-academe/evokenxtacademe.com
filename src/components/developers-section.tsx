...
const features = [
  { 
    ...
    description: "HD video content by expert ACCA tutors for every paper."
  },
  { 
    title: "Downloadable resources", 
    description: "Study notes, revision kits, and past exam papers."
  },
  { 
  ...
  { 
    ...
    description: "Connect with fellow ACCA students and share insights."
  },
];
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        >
          <p className="text-xl text-muted-foreground mb-12 leading-relaxed max-w-md">
            Comprehensive study materials designed to help you master every ACCA paper. 
            Study at your pace with expert-crafted content.
          </p>
