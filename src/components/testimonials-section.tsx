...
const testimonials = [
  {
    quote: "The structured lectures and mock exams helped me clear all three Knowledge level papers in my first attempt.",
    author: "Priya Sharma",
    role: "ACCA Student",
    company: "Evoke Edu Global",
    metric: { value: "3/3", label: "Papers passed first attempt" },
  },
  {
    quote: "I studied entirely online while working full-time. The flexible schedule and quality content made it possible.",
    author: "James Okonkwo",
    role: "Finance Analyst",
    company: "Evoke Edu Global",
    metric: { value: "100%", label: "Online learning" },
  },
  {
    quote: "The expert tutors break down complex topics so clearly. Performance Management went from my weakest to strongest paper.",
    author: "Fatima Al-Hassan",
    role: "ACCA Affiliate",
    company: "Evoke Edu Global",
    metric: { value: "85%", label: "PM exam score" },
  },
  {
    quote: "After completing my ACCA through Evoke, I landed a senior accountant role. The investment was absolutely worth it.",
    author: "David Chen",
    role: "Senior Accountant",
    company: "Evoke Edu Global",
    metric: { value: "2x", label: "Salary increase" },
  },
];
