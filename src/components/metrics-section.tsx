...
const metrics = [
  { 
    ...
    sublabel: "by 12,000+ active students",
  },
  { 
    value: 95, 
    suffix: "%", 
    ...
    sublabel: "based on course reviews",
  },
  { 
    value: 4, 
    suffix: ".8/5", 
    ...
    sublabel: "across all ACCA courses",
  },
];
    ...
    <section ref={sectionRef} className="relative py-32 lg:py-40 overflow-hidden">
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className={`mt-16 pt-8 border-t border-foreground/10 flex flex-wrap items-center gap-x-12 gap-y-4 text-sm font-mono text-muted-foreground transition-all duration-1000 delay-500 ${
          ...
          <span>Financial Accounting (FA)</span>
          <span>Performance Management (PM)</span>
          <span>Audit & Assurance (AA)</span>
          <span>Financial Reporting (FR)</span>
          <span className="text-foreground">+9 more ACCA papers</span>
        </div>
      </div>
    </section>
  );
