...
const securityFeatures = [
  {
    ...
    description: "Step-by-step syllabus aligned with official ACCA guidelines.",
    image: "/images/curriculum.jpg",
  },
  {
    icon: Users,
    title: "Expert tutors",
    description: "Learn from qualified ACCA professionals with years of teaching experience.",
  ...
  },
  {
    ...
    description: "Mock exams, past papers, and revision kits to ensure you pass.",
    image: "/images/exams.jpg",
  },
];

const certifications = ["ACCA Approved", "IFRS Aligned", "CPD Accredited", "Globally Recognised"];
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="mb-20">
          ...
          <h2 className={`text-6xl md:text-7xl lg:text-[128px] font-display tracking-tight leading-[0.9] mb-12 transition-all duration-1000 ${
            ...
            Comprehensive,
            <br />
            <span className="text-muted-foreground">learning support.</span>
          </h2>
          ...
          <div className={`transition-all duration-1000 delay-100 ${
            ...
            <p className="text-xl text-muted-foreground leading-relaxed max-w-2xl">
              Everything you need to pass your ACCA exams. Expert guidance, structured content, and continuous support throughout your journey.
            </p>
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-12 gap-6">
          ...
          <div className={`lg:col-span-7 relative p-8 lg:p-12 border border-foreground/10 min-h-[400px] overflow-hidden transition-all duration-700 ${
            ...
            <div className="relative z-10">
              <span className="font-mono text-sm text-muted-foreground">Student success</span>
              <div className="mt-8">
                <span className="text-7xl lg:text-8xl font-display">95%</span>
                <span className="block text-muted-foreground mt-2">Exam pass rate this year</span>
              </div>
            </div>
