...
const steps = [
  {
    ...
    title: "Explore",
    subtitle: "your path",
    description: "Browse ACCA qualification levels — Knowledge, Skill, and Professional. Choose papers that match your career goals and current experience.",
    code: "",
  },
  {
    number: "02",
    title: "Enrol",
    subtitle: "& learn",
    description: "Register for expert-led courses with structured video lectures, practice questions, and mock exams. Study at your own pace from anywhere.",
    code: "",
  },
  {
    number: "03",
    title: "Achieve",
    subtitle: "& grow",
    description: "Track your progress with real-time dashboards. Earn your ACCA qualification and unlock global career opportunities in finance and accounting.",
    code: "",
  },
];
        ...
        <div className="relative mb-0 lg:mb-0 grid lg:grid-cols-2 gap-4 lg:gap-12 items-end">
          ...
          <div className="overflow-hidden pb-0 lg:pb-32">
            ...
            <h2 className={`text-6xl md:text-7xl lg:text-[128px] font-display tracking-tight leading-[0.85] transition-all duration-1000 delay-100 ${
              ...
              <span className="block text-white/30">Enrol.</span>
